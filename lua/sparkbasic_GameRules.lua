...
class 'SparkBasicGamerules' (Gamerules)

SparkBasicGamerules.kMapName = "sparkbasic_gamerules"
...
if Server then
	...
	SparkBasicGamerules.kCountdownSound = PrecacheAsset("sound/NS2.fev/common/countdown")
	...
	function SparkBasicGamerules:SetGameState(state)
    ...
    function SparkBasicGamerules:GetGameTimeChanged()
        return self.timeSinceGameStateChanged
    end

    function SparkBasicGamerules:GetGameState()
